...
Vector BoundingBoxFactor::evaluateError(const Pose3 &pose,
  ...
  try {
    ...
    if (NUMERICAL_DERIVATIVE) {
      std::function<Vector(const Pose3 &, const ConstrainedDualQuadric &)>
          funPtr(std::bind(&BoundingBoxFactor::evaluateError, this,
...
/* ************************************************************************* */
Matrix
BoundingBoxFactor::evaluateH1(const Pose3 &pose,
...
/* ************************************************************************* */
Matrix
BoundingBoxFactor::evaluateH2(const Pose3 &pose,
                              const ConstrainedDualQuadric &quadric) const {
  Matrix H2;
